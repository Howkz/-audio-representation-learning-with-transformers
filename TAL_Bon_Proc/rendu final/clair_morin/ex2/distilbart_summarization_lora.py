...
MODEL_KEY = "distilbart-lora"
MODEL_NAME = "distilbart-cnn-sum-lora-fast"
PRETRAINED_NAME = "sshleifer/distilbart-cnn-12-6"
...
def evaluate_on_test(
    model,
    tokenizer,
    test_generation_dataset: Dataset,
    ...
    total_samples = len(test_generation_dataset)
    ...
    try:
        for start in tqdm(
            ...
            if generation_progress_path and not saved_halfway and processed_samples >= halfway_sample:
                # Checkpoint intermediaire: evite de perdre toute la generation test en cas de crash.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Exercise 2 - distilbart-lora")
