...
MODEL_NAME = "bert-base-uncased-full-fast"
PRETRAINED_MODEL_NAME = "bert-base-uncased"
MODEL_NAME_SHORT = "bert_full_fast"
ARCHITECTURE = "Encodeur"
ADAPTATION = "Full fine-tuning (full dataset, speed-optimized)"
TASK_NAME = "ex1"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Exercice 1 - BERT full fine-tuning full-fast sur LEDGAR")
...
def build_model(num_labels, label_names):
    """Instancie BERT de classification avec mapping des labels."""
...
def build_trainer(
    ...
    """Construit le Trainer configure pour le full fine-tuning."""
