...
MODEL_KEY = "distilgpt2-ex3-roleplay"
MODEL_NAME = "distilgpt2-ex3-roleplay"
PRETRAINED_NAME = "distilbert/distilgpt2"
ADAPTATION = "Role-playing with safety constraints"
STRATEGY_NAME = "roleplay-safety"
...
def build_prompt(clause_text: str) -> str:
    """Construit le prompt roleplay avec contraintes de surete."""
    return (
        "System role: You are a legal simplification assistant.\n"
        "Task: explain legal clauses for non-lawyers in plain English.\n"
        "Hard constraints: do not provide legal advice, do not invent obligations, keep factual tone.\n\n"
        f"User clause:\n{clause_text}\n\n"
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Exercice 3 - DistilGPT-2 roleplay prompting")
