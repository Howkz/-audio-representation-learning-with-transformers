...
\paragraph{Justification du plan}
Établir un point de référence frugal, stable et compatible avec la contrainte 15 Go.
...
\textbf{Source auto}: configuration héritée du rang screening 1.
...
\textbf{Phase}: final\\
\textbf{Seeds prévues}: 42, 123, 456, 789, 1024\\
\textbf{Source auto}: configuration héritée du rang screening 2.

\paragraph{Justification du plan}
Consolidation statistique de la deuxième meilleure variante screening.
...
\textbf{Phase}: final\\
\textbf{Seeds prévues}: 42, 123, 456, 789, 1024\\
\textbf{Source auto}: configuration héritée du rang screening 3.

\paragraph{Justification du plan}
Consolidation statistique de la troisième meilleure variante screening.
