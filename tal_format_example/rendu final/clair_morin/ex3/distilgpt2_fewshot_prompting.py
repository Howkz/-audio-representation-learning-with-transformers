...
MODEL_KEY = "distilgpt2-ex3-fewshot"
MODEL_NAME = "distilgpt2-ex3-fewshot"
PRETRAINED_NAME = "distilbert/distilgpt2"
ADAPTATION = "Few-shot prompting (in-context examples)"
STRATEGY_NAME = "few-shot-icl"
...
FEWSHOT_EXAMPLE_1_CLAUSE = (
    "This Agreement shall be governed by and construed in accordance with the laws "
    "of the State of New York, without regard to conflict of laws principles."
)
FEWSHOT_EXAMPLE_1_EXPLANATION = (
    "If there is a legal dispute about this contract, New York law will be used to interpret it."
)
FEWSHOT_EXAMPLE_2_CLAUSE = (
    "Either party may terminate this Agreement upon thirty (30) days prior written notice to the other party."
)
FEWSHOT_EXAMPLE_2_EXPLANATION = (
    "Either side can end the contract, but they must send written notice at least 30 days in advance."
)


def build_prompt(clause_text: str) -> str:
    """Construit le prompt few-shot avec deux exemples in-context."""
    return (
        "You explain legal clauses in plain English for non-experts.\n"
        "Stay faithful to the clause. Do not add legal advice or new obligations.\n\n"
        "Example 1\n"
        f"Clause: {FEWSHOT_EXAMPLE_1_CLAUSE}\n"
        f"Explanation: {FEWSHOT_EXAMPLE_1_EXPLANATION}\n\n"
        "Example 2\n"
        f"Clause: {FEWSHOT_EXAMPLE_2_CLAUSE}\n"
        f"Explanation: {FEWSHOT_EXAMPLE_2_EXPLANATION}\n\n"
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Exercice 3 - DistilGPT-2 few-shot prompting")
