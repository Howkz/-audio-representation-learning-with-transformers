...
MODEL_NAME = "bert-base-uncased-lora-full-fast"
PRETRAINED_MODEL_NAME = "bert-base-uncased"
MODEL_NAME_SHORT = "bert_lora_full_fast"
ARCHITECTURE = "Encodeur"
ADAPTATION = "LoRA (BERT, full dataset, speed-optimized)"
TASK_NAME = "ex1"
...
# LoRA: sous-espace de parametres entraine, LR typiquement plus eleve que full fine-tuning.
LEARNING_RATE = 2e-4
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Exercice 1 - BERT LoRA full-fast sur LEDGAR")
...
def build_model(num_labels, label_names):
    """Construit BERT LoRA de classification avec mapping des labels."""
    ...
    peft_config = LoraConfig(
        # LoRA: on ajoute de petites matrices adaptees dans les projections attention.
...
def build_trainer(
    ...
    """Construit le Trainer configure pour LoRA."""
