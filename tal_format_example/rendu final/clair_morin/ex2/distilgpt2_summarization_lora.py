...
MODEL_KEY = "distilgpt2-lora"
MODEL_NAME = "distilgpt2-sum-lora-fast"
PRETRAINED_NAME = "distilgpt2"
ARCHITECTURE = "Decodeur uniquement"
ADAPTATION = "Prompted causal summarization + LoRA (distilled)"
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Exercise 2 - distilgpt2-lora")
